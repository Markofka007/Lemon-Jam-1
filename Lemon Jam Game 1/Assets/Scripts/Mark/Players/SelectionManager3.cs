...
public class SelectionManager3 : MonoBehaviour
{
    ...
    public void Select(InputAction.CallbackContext ctx)
    {
        if (ctx.performed)
        {
            //GameObject player3 = Instantiate(player3Prefab, Vector3.zero, Quaternion.identity);
            //player3.GetComponent<SpriteRenderer>().sprite = playerSprites[playerSelection - 1];
